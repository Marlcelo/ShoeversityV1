...
$("#btnAddFamily").click(function () {
    $("#newField0").append('<br><div class="row"><div class="col-lg-2"><label>Type:</label><select class="form-control" id="rType' + counter + '" name="rType' + counter + '" required><option value="parent">Parent</option><option value="sibling">Sibling</option><option value="spouse">Spouse</option><option value="children">Children</option></select></div><div class="col-lg-5"><label>Name:</label><input type="text" class="form-control" id="rName' + counter + '" name = "rName' + counter + '" required></div><div class="col-lg-5"><label>Date of Birth:</label><input type="Date" class="form-control" id="rBirth' + counter + '" name = "rBirth' + counter + '"required></div></div><br><div class="row"><div class="col-lg-6"><input type="text" class="form-control" id="rOccupation' + counter + '" placeholder="Occupation:" name = "rOccupation' + counter + '"required></div><div class="col-lg-6"><input type="text" class="form-control" id="rEmployer' + counter + '" placeholder="Employer:" name = "rEmployer' + counter + '"required></div></div>');
    alert("Counter: " + counter);
    counter++;
});

$("#btnAddEmployment").click(function(){
	$("#employmentField").append('<br><label>'+ counter2 +'.</label><div class="row"><div class="col-lg-3"><label>Company:</label><input type="text" class="form-control" id="companyName' + counter2 + '" name = "companyName'+ counter2+'" required></div><div class="col-lg-3"><label>Company Tel#</label><input type="tel" class="form-control" id="companyTel' + counter2 + '" name = "companyTel' + counter2 + '" maxlength="11" required></div><div class="col-lg-3"><label>Position:</label><input type="text" class="form-control" id="position' + counter2 + '" name = "position' + counter2 + '" required></div><div class="col-lg-3"><label>Basic Salary(Php):</label> <input type="number" step="any" min="0" class="form-control" id="salary' + counter2 + '" name = "salary' + counter2 + '" required></div></div><br><div class="row"><div class="col-lg-12"><label>Address:</label><input type="text" class="form-control" id="address' + counter2 + '"  name = "address' + counter2 + '" required></div></div><div class="row"><div class="col-lg-4"><label>Supervisor:</label><input type="text" class="form-control" id="supervisorName' + counter2 + '"  name = "supervisorName' + counter2 + '" required></div><div class="col-lg-3"><label>Supervisor Contact#:</label><input type="tel" class="form-control" id="supervisorNum' + counter2 + '"  name = "supervisorNum' + counter2 + '" maxlength="11" required></div><div class="col-lg-5"><label>Nature of Business:</label><input type="text" class="form-control" id="nob' + counter2 + '"  name = "nob' + counter2 + '" required></div></div><div class="row"><div class="col-lg-3"><label>From:</label><input type="date" class="form-control" id="from' + counter2 + '"  name = "from' + counter2 + '" required></div><div class="col-lg-3"><label>To:</label><input type="date" class="form-control" id="to' + counter2 + '"  name = "to' + counter2 + '" required></div><div class="col-lg-6"><label>Reason for Leaving:</label><input type="text" class="form-control" id="rfl' + counter2 + '"  name = "rfl' + counter2 + '" required></div></div><div class="row"><div class="col-lg-12"><label>Main Responsibilities:</label><input type="text" class="form-control" id="responsibilities' + counter2 + '"  name = "responsibilities' + counter2 + '" required></div></div>');
